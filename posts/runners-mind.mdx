...
summary: 'I wrote this poem to capture the transition between a stressed version of myself to the relaxed composed person I am after a good run'
image: '/images/run.jpeg'
---
blowing carbon from my lungs, perennials, and mountainous gravel downhills 
